...
def test_restriction_double_pattern():
    xsd_schema = XMLSchema("data/types_built_in_restricted/double_pattern.xsd")
...
def test_restriction_double_enumeration():
    xsd_schema = XMLSchema("data/types_built_in_restricted/double_enumeration.xsd")
    local_config = GeneratorConfig()
    generated_xml = generator.generate_xml(xsd_schema, local_config)
    xml_str = etree.tostring(generated_xml, pretty_print=True)
    generated_value = re.sub("<root attributeValue=\"|\"/>\s", "", xml_str.decode('utf-8'))
...
def test_restriction_double_whitespace():
    xsd_schema = XMLSchema("data/types_built_in_restricted/double_whitespace.xsd")
    local_config = GeneratorConfig()
    generated_xml = generator.generate_xml(xsd_schema, local_config)
    xml_str = etree.tostring(generated_xml, pretty_print=True)
    generated_value = re.sub("<root attributeValue=\"|\"/>\s", "", xml_str.decode('utf-8'))
...
@pytest.mark.flaky(reruns=10)
def test_restriction_double_inclusive():
    xsd_schema = XMLSchema("data/types_built_in_restricted/double_inclusive.xsd")
    local_config = GeneratorConfig()
    generated_xml = generator.generate_xml(xsd_schema, local_config)
    xml_str = etree.tostring(generated_xml, pretty_print=True)
...
@pytest.mark.flaky(reruns=10)
def test_restriction_double_exclusive():
    xsd_schema = XMLSchema("data/types_built_in_restricted/double_exclusive.xsd")
    local_config = GeneratorConfig()
    generated_xml = generator.generate_xml(xsd_schema, local_config)
    xml_str = etree.tostring(generated_xml, pretty_print=True)
    generated_value = float(re.sub("<root attributeValue=\"|\"/>\s", "", xml_str.decode('utf-8')))
