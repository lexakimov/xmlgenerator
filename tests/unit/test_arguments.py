...
def test_parse_args__one_schema__not_exists(capsys):
    with pytest.raises(SystemExit) as excinfo:
...
def test_parse_args__one_schema__exists(capsys):
...
def test_parse_args__one_schema__twice(capsys):
...
def test_parse_args___two_schemas__exists(capsys):
...
def test_parse_args__one_schema__check_output_is_file(capsys):
...
def test_parse_args__two_schemas__check_output_is_dir(capsys):
    with pytest.raises(SystemExit) as excinfo:
...
def test_parse_args__two_schemas__create_output_folder(capsys):
...
def test_parse_args__folder__not_empty(capsys):
...
def test_parse_args__folder_empty(capsys):
    with pytest.raises(SystemExit) as excinfo:
        parse('program ./')
